...
func TestHandleMsg(t *testing.T) {
	...
	// with a matched payload. msgPreprepare should match with *arfist.Preprepare in normal case.
	msg := &message{
		Code:          msgPreprepare,
		Msg:           m,
		Address:       v0.Address(),
	...
	// with a unmatched payload. msgPrepare should match with *arfist.Subject in normal case.
	msg = &message{
		Code:          msgPrepare,
		Msg:           m,
		Address:       v0.Address(),
	...
	// with a unmatched payload. arfist.MsgCommit should match with *arfist.Subject in normal case.
	msg = &message{
		Code:          msgCommit,
		Msg:           m,
		Address:       v0.Address(),
