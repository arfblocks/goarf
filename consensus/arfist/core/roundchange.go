...
func (c *core) handleRoundChange(msg *message, src arfist.Validator) error {
	logger := c.logger.New("state", c.state, "from", src.Address().Hex())

	// Decode ROUND CHANGE message
	var rc *arfist.Subject
...
func newRoundChangeSet(valSet arfist.ValidatorSet) *roundChangeSet {
...
type roundChangeSet struct {
	validatorSet arfist.ValidatorSet
