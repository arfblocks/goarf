...
func (c *core) handleEvents() {
	...
	for {
		...
		case event, ok := <-c.finalCommittedSub.Chan():
			...
			case arfist.FinalCommittedEvent:
...
func (c *core) handleMsg(payload []byte) error {
	...
	if src == nil {
		...
		return arfist.ErrUnauthorizedAddress
	}

	return c.handleCheckedMsg(msg, src)
}

func (c *core) handleCheckedMsg(msg *message, src arfist.Validator) error {
