...
import "github.com/tayfunakcay/goArf/consensus/arfist"
...
func (c *core) checkRequestMsg(request *arfist.Request) error {
...
func (c *core) storeRequestMsg(request *arfist.Request) {
...
func (c *core) processPendingRequests() {
	...
	for !(c.pendingRequests.Empty()) {
		...
		go c.sendEvent(arfist.RequestEvent{
			Proposal: r.Proposal,
		})
	}
}
