...
func TestHandlePrepare(t *testing.T) {
	...
	expectedSubject := &arfist.Subject{
		View: &arfist.View{
			Round:    big.NewInt(0),
...
func TestVerifyPrepare(t *testing.T) {
	...
	valSet := validator.NewSet([]common.Address{peer.Address()}, arfist.RoundRobin)
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: nil,
			prepare: &arfist.Subject{
				View:   &arfist.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&arfist.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
				valSet,
			),
		},
		{
			...
			roundState: newTestRoundState(
				&arfist.View{Round: big.NewInt(1), Sequence: big.NewInt(1)},
				valSet,
			),
		},
		{
		...
		},
		{
			...
			expected: errInconsistentSubject,
			prepare: &arfist.Subject{
				View:   &arfist.View{Round: big.NewInt(0), Sequence: nil},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&arfist.View{Round: big.NewInt(1), Sequence: big.NewInt(1)},
		...
		},
		{
			...
			expected: errInconsistentSubject,
			prepare: &arfist.Subject{
				View:   &arfist.View{Round: big.NewInt(1), Sequence: big.NewInt(0)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&arfist.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
		...
		},
		{
			...
			expected: errInconsistentSubject,
			prepare: &arfist.Subject{
				View:   &arfist.View{Round: big.NewInt(0), Sequence: big.NewInt(1)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&arfist.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
