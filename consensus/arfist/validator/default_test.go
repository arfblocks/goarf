...
func testNewValidatorSet(t *testing.T) {
	var validators []arfist.Validator
	const ValCnt = 100
	...
	// Create ValidatorSet
	valSet := NewSet(ExtractValidators(b), arfist.RoundRobin)
	if valSet == nil {
...
func testNormalValSet(t *testing.T) {
	...
	valSet := newDefaultSet([]common.Address{addr1, addr2}, arfist.RoundRobin)
	if valSet == nil {
...
func testEmptyValSet(t *testing.T) {
	valSet := NewSet(ExtractValidators([]byte{}), arfist.RoundRobin)
	if valSet == nil {
