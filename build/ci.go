...
import (
	...
	"github.com/tayfunakcay/goArf/internal/build"
)
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("goArf requires at least Go version 1.9 and cannot")
...
type debMetadata struct {
	...
	// goArf version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/tayfunakcay/goArf/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/tayfunakcay/goArf/mobile")
